...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/appmap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12478&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/appmap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `appmap` can be installed with:

```
conda install appmap
```

It is possible to list all of the versions of `appmap` available on your platform with:
